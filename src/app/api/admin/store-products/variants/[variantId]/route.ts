...
export async function PUT(
  ...
  try {
    ...
    const laravelRes = await fetch(
      `${config.apiBase}/api/admin/variants/${variantId}`,
      {
        method: "PUT",
        headers: {
    ...
    console.error("UPDATE PRODUCT VARIANT PROXY ERROR:", error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE PRODUCT VARIANT PROXY ERROR:", error);
