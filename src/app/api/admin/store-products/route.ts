...
export async function GET() {
  ...
  try {
    const laravelRes = await fetch(`${config.apiBase}/api/admin/products`, {
      method: "GET",
      headers: {
    ...
    console.error("GET STORE PRODUCTS PROXY ERROR:", error);
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("STORE PRODUCTS PROXY ERROR:", error);
