...
export async function GET(
  ...
  try {
    const laravelRes = await fetch(`${config.apiBase}/api/admin/products/${id}`, {
      method: "GET",
      headers: {
    ...
    console.error("GET STORE PRODUCT BY ID PROXY ERROR:", error);
...
export async function PUT(
  ...
  try {
    ...
    console.error("UPDATE STORE PRODUCT PROXY ERROR:", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH STORE PRODUCT PROXY ERROR:", error);
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      data ?? { ok: true, message: "Prodotto eliminato con successo" },
      { status: 200 }
    );
  } catch (error) {
    console.error("DELETE STORE PRODUCT PROXY ERROR:", error);
